...
# ============================================
# 🎨 Modern Safety-Themed UI
# ============================================
def set_custom_theme():
    st.markdown(f"""
    <style>
        /* Professional Safety Color Palette */
        :root {{
            --safety-primary: #005F87;  /* Deep safety blue */
            --safety-secondary: #FF7900;  /* Safety orange */
            --safety-accent: #E63946;  /* Alert red */
            --safety-success: #4CAF50;  /* Compliance green */
            --safety-light: #F8F9FA;
            --safety-dark: #212529;
        }}
        ...
        /* Modern card design with subtle animation */
        .card {{
            ...
            margin-bottom: 25px;
            border-left: 5px solid var(--safety-primary);
        }}
        ...
        .stButton>button {{
            background-color: var(--safety-primary);
            color: white;
            border: none;
            padding: 12px 28px;
            border-radius: 8px;
            ...
            box-shadow: 0 4px 6px rgba(0, 95, 135, 0.15);
        }}
        
        .stButton>button:hover {{
            background-color: #004A6A;
            transform: translateY(-2px);
            box-shadow: 0 6px 12px rgba(0, 95, 135, 0.2);
        }}

        /* Elegant sidebar styling */
        .css-1d391kg {{
            background: var(--safety-primary) !important;
        ...
        .stTabs [aria-selected="true"] {{
            background-color: var(--safety-primary) !important;
            color: white !important;
        }}
    ...
    with tab2:
        ...
        **Note:** Live inspection requires camera access. 
        ...
        if st.button("▶️ Start Live Inspection", key="live_start"):
            ...
            stop_button_pressed = st.button("⏹️ Stop Inspection")
            ...
            try:
                while cam.isOpened() and not stop_button_pressed:
                    ...
                    if missing:
                        st.warning(f"""
                        <div style="background: #FFF3E0; padding: 15px; border-radius: 8px; border-left: 4px solid #FFA000; margin: 10px 0;">
                            <div style="display: flex; align-items: center; gap: 8px;">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#FFA000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    <circle cx="12" cy="12" r="10"></circle>
                            ...
                            <p style="color: #5D4037; margin: 8px 0 0 0;">Missing equipment: {', '.join(missing)}</p>
                        </div>
                        """, unsafe_allow_html=True)
                        ...
                        <div style="background: #E8F5E9; padding: 15px; border-radius: 8px; border-left: 4px solid #4CAF50; margin: 10px 0;">
                            ...
                            <p style="color: #2E7D32; margin: 8px 0 0 0;">Worker is properly equipped</p>
                        </div>
                        """, unsafe_allow_html=True)
                        if enable_audio and (current_time - last_alert_time) > alert_cooldown:
                            play_alert("All safety equipment detected")
                            last_alert_time = current_time
